...
- 조정 책임자: Codex
- 현재 활성 작업: SG-004 revision 2 (`in_progress`, 현재 사람 지시로 Codex corrective pass 수행 중)
...
SG-004 revision 1은 Antigravity가 frozen substantive SHA `b0fb73b5aa520986a810177e81e120df20e52dbd`로 제출했고 형식 리뷰 `019f6a18-79e7-7f12-a40a-e67e448a1a00`의 `Approved` 결과를 받았다. 그러나 Codex integrator의 독립 수용 기준 재검증에서 SG-004-AC02~AC08 미충족이 확인돼 병합하지 않았다. 2026-07-17(Asia/Seoul) 현재 사람의 “여기서 통과될 때까지 수정 진행” 지시는 시작 SHA `50fc8caf1d76449b97a903ff3f41f92ca07acbab`에서 Codex가 같은 docs-only 범위를 보완하는 revision 2를 승인한다. 이는 작성자/branch 편차만 승인하며 제품 의미·계약·결정·배포를 바꾸지 않는다. revision 1 리뷰는 새 본문에 적용되지 않고, Codex self-check 뒤 사람 또는 비-Codex 플랫폼의 독립 리뷰가 필요하다. `SG-004-DN01`은 H0b 사람 결정으로 유지하며 Wave 1은 계속 대기한다.

## 작업 스냅샷

| Wave | 상태 | 비고 |
|---|---|---|
| 0. 계약·캘리브레이션 | in_progress | H0a 승인 완료; SG-003 완료, SG-004 revision 2 corrective pass 진행, 사람 H0b 대기 |
